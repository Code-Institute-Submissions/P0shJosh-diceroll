window.addEventListener("load", () => {
    ...
    const allthedice = [
        { selected: 'boost', image: "assets/images/starwars/dice_boost.png", results: [
          ...
          { result: 'twoadvantage', value: 5, image: "assets/images/starwars/result_twoadvantage.png" },
          { result: 'adv&suc', value: 6, image: "assets/images/starwars/result_adv_suc.png" },
        ]},
        { selected: 'ability', image: "assets/images/starwars/dice_ability.png", results: [
          ...
          { result: 'adv&suc', value: 6, image: "assets/images/starwars/result_adv_suc.png" },
          { result: 'twosuccess', value: 7, image: "assets/images/starwars/result_twosuccess.png" },
          { result: 'twoadvantage', value: 8, image: "assets/images/starwars/result_twoadvantage.png" },
        ]},
        { selected: 'proficiency', image: "assets/images/starwars/dice_proficiency.png", results: [
          ...
          { result: 'advantage', value: 5, image: "assets/images/starwars/result_advantage.png" },
          { result: 'adv&suc', value: 6, image: "assets/images/starwars/result_adv_suc.png" },
          { result: 'adv&suc', value: 7, image: "assets/images/starwars/result_adv_suc.png" },
          { result: 'adv&suc', value: 8, image: "assets/images/starwars/result_adv_suc.png" },
          { result: 'twosuccess', value: 9, image: "assets/images/starwars/result_twosuccess.png" },
          { result: 'twosuccess', value: 10, image: "assets/images/starwars/result_twosuccess.png" },
          { result: 'twoadvantage', value: 11, image: "assets/images/starwars/result_twoadvantage.png" },
          { result: 'twoadvantage', value: 12, image: "assets/images/starwars/result_twoadvantage.png" },
        ]},
        ...
        { selected: 'difficulty', image: "assets/images/starwars/dice_difficulty.png", results: [ 
          ...
          { result: 'fail&threat', value: 7, image: "assets/images/starwars/result_fail_threat.png" },
          { result: 'twothreat', value: 8, image: "assets/images/starwars/result_twothreat.png" },
        ]},
        { selected: 'challenge', image: "assets/images/starwars/dice_challenge.png", results: [ 
          { result: 'blank', value: 1, image: "assets/images/starwars/force_light.png" },
          { result: 'despair', value: 2, image: "assets/images/starwars/result_despair.png" },
          { result: 'fail', value: 3, image: "assets/images/starwars/result_failure.png" },
          { result: 'fail', value: 4, image: "assets/images/starwars/result_failure.png" },
          { result: 'threat', value: 5, image: "assets/images/starwars/result_threat.png" },
          { result: 'threat', value: 6, image: "assets/images/starwars/result_threat.png" },
          { result: 'twofail', value: 7, image: "assets/images/starwars/result_twofailure.png" },
          { result: 'twofail', value: 8, image: "assets/images/starwars/result_twofailure.png" },
          { result: 'twothreat', value: 9, image: "assets/images/starwars/result_twothreat.png" },
          { result: 'twothreat', value: 10, image: "assets/images/starwars/result_twothreat.png" },
          { result: 'fail&threat', value: 11, image: "assets/images/starwars/result_fail_threat.png" },
          { result: 'fail&threat', value: 12, image: "assets/images/starwars/result_fail_threat.png" },
        ]},
